"""
scraper_anossadrogaria.py — Scraper for A Nossa Drogaria (https://www.anossadrogaria.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_anossadrogaria              # scrape -> DB
    python -m markets.paguemenos.scraper_anossadrogaria --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_anossadrogaria --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.anossadrogaria.com.br"
...
_SKIP_IDS: set = set()   # no SEM CATEGORIA dept; walk all leaves
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape A Nossa Drogaria -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import AnossaDrogariaDB, load_env
    load_env(args.env)
